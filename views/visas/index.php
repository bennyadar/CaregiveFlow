        ...
        <table class="table table-striped align-middle">
            ...
            <?php foreach ($items as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a class="btn btn-sm btn-outline-secondary" href="?r=visas/view&id=<?= e($row['id']) ?>">צפייה</a>
                        <a class="btn btn-sm btn-outline-primary" href="?r=visas/edit&id=<?= e($row['id']) ?>">עריכה</a>
