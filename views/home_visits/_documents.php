...
<div class="card mt-4">
  ...
  <div class="card-body">
    <form method="post" enctype="multipart/form-data" class="row gy-2 gx-2 align-items-end" action="index.php?r=home_visits/upload_document">
            ...
            <tr>
              ...
              <td class="text-end">
                <a class="btn btn-sm btn-outline-danger"
                   href="index.php?r=home_visits/delete_document&doc_id=<?= e($d['id']) ?>&visit_id=<?= e($item['id']) ?>"
