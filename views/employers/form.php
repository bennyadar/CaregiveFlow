...
<?php
// ===== טופס מעסיק (יצירה/עריכה) – מיושר ל-UI conventions =====
$formId = 'employer-form';
$cancelUrl = 'index.php?r=employers/index';
$title = isset($item['id']) ? 'עריכת מעסיק #' . (int)$item['id'] : 'מעסיק חדש';
...
<form id="<?= e($formId) ?>" method="post" class="row g-3">
  ...
  <?php
    // שכפול כפתורי הפעולה בתחתית – תואם למסך עובד חדש
    $wrapperClass = 'col-12 d-flex gap-2';
    include __DIR__ . '/../partials/form_actions.php';
  ?>
</form>
