...
<?php
// ===== טופס עובד (יצירה/עריכה) – מיושר ל-UI conventions =====
$formId = 'employee-form';
$cancelUrl = 'index.php?r=employees/index';
$title = isset($item['id']) ? 'עריכת עובד #' . (int)$item['id'] : 'עובד חדש';
...
<form id="<?= e($formId) ?>" method="post" class="row g-3">
  ...
  <hr class="mt-4">
  <h2 class="h6">כתובת עובד בחו״ל</h2>
  <div class="row g-3">
    <div class="col-md-2">
  ...
  <hr class="mt-4">
  <h2 class="h6">פרטי בנק בחו״ל + מוטב</h2>
  <div class="row g-3">
    <div class="col-md-2">
  ...
  <div class="col-12">
  <?php
    // כפתורי שמירה/ביטול בתחתית הטופס
    $wrapperClass = 'd-flex gap-2';
    include __DIR__ . '/../partials/form_actions.php';
  ?>
</div>
