...
// ===== כותרת מסך + פעולות =====
$id = (int)($item['id'] ?? 0);
$title = 'פרטי ביקור בית';
$subtitle = '#' . $id;

ob_start();
?>
  <a class="btn btn-primary" href="index.php?r=home_visits/edit&id=<?= e($id) ?>">עריכה</a>
  <a class="btn btn-outline-secondary" href="index.php?r=home_visits">חזרה לרשימה</a>
  <?php if (!empty($emp['id'])): ?>
    <a class="btn btn-outline-secondary" href="index.php?r=employees/show&id=<?= e($emp['id']) ?>">חזרה לכרטיס עובד</a>
  <?php endif; ?>
<?php
