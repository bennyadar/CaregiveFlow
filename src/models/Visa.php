...
class Visa
{
    ...
    public function all(array $filters = [], int $limit = 25, int $offset = 0): array
    {
        ...
        // מבנה זהה למודול דרכונים: v.* + שדות עובדים מצורפים.
        // כך ה-views עובדים בעקביות כמו passports/index.php.
        $sql = "SELECT v.*, e.first_name, e.last_name, e.passport_number AS employee_passport
                  FROM visas v
