...
ob_start();
?>
  <a class="btn btn-primary" href="index.php?r=employers/edit&id=<?= $id ?>">עריכה</a>
  <a class="btn btn-outline-secondary" href="index.php?r=employer_passports/index&employer_id=<?= $id ?>">דרכונים</a>
  <a class="btn btn-outline-secondary" href="index.php?r=employment_permits/index&employer_id=<?= $id ?>">היתרי העסקה</a>
  <a class="btn btn-outline-secondary" href="index.php?r=employer_fees/index&employer_id=<?= $id ?>">דמי תאגיד</a>
