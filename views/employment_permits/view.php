...
<div class="container" dir="rtl" style="max-width: 860px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-2">
            <a class="btn btn-outline-primary" href="?r=employment_permits/edit&id=<?= e($item['id']) ?>">עריכה</a>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    <div><strong>מעסיק:</strong> <?= e($emp ? ($emp['last_name'].' '.$emp['first_name'].' ('.($emp['id_number'] ?? $emp['passport_number']).')') : '—') ?></div>
                    <div><strong>מס׳ היתר:</strong> <?= e($item['permit_number']) ?></div>
                    <div><strong>סוג היתר:</strong> <?= e($type_codes[(int)($item['permit_type_code'] ?? -1)] ?? '—') ?></div>
                </div>
                <div class="col-md-6">
